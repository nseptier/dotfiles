...
local hlGroups = {
  ...
  WinBar                                                = { fg = Color.COMMENT, bg = Color.BACKGROUND_SEMIDARK, italic = true },
  WinBarNC                                              = { fg = Color.COMMENT, bg = Color.BACKGROUND_SEMIDARK, italic = true },
  ...
  TreesitterContextLineNumber                           = { bg = Color.BACKGROUND_LIGHT },
  TreesitterContextSeparator                            = { fg = '#292e32', bg = Color.BACKGROUND_LIGHT },

  WinbarSeparator                                       = { fg = Color.BACKGROUND, bg = Color.BACKGROUND_SEMIDARK },
  WinbarPath                                            = { bg = Color.BACKGROUND },
