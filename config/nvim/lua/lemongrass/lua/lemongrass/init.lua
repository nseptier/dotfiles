...
local Colorscheme = {
  ...
  listSelect = { fg = Color.TYPE_BUILTIN, bg = Color.BACKGROUND_SEMIDARK },
}
...
local hlGroups = {
  ...
  StatuslineLocationCurrent = { fg = Color.VARIABLE, bg = Color.BACKGROUND_SEMIDARK },
  StatuslineLocation = { fg = Color.KEYWORD, bg = Color.BACKGROUND_SEMIDARK },
  StatuslineLocationSeparator = { fg = Color.BACKGROUND_SEMIDARK, bg = Color.BACKGROUND },
  StatuslineMode = { fg = Color.VARIABLE, bg = Color.BACKGROUND_DARK },
  StatuslineModeSeparator = { fg = Color.BACKGROUND_DARK, bg = Color.BACKGROUND_SEMIDARK },
  StatuslineFileInfo = { fg = Color.COMMENT, bg = Color.BACKGROUND },
  StatuslineReset = { fg = Color.VARIABLE, bg = Color.BACKGROUND },
  StatuslineError = { fg = Color.ERROR, bg = Color.BACKGROUND_SEMIDARK },
  StatuslineWarn = { fg = Color.WARNING, bg = Color.BACKGROUND_SEMIDARK },
  StatuslineInfo = { fg = Color.INFO, bg = Color.BACKGROUND_SEMIDARK },
  StatuslineHint = { fg = Color.HINT, bg = Color.BACKGROUND_SEMIDARK },
  StatuslineFolder = { fg = Color.COMMENT, bg = Color.BACKGROUND_DARK },
  StatuslineFilename = { fg = Color.TYPE_DECL, bg = Color.BACKGROUND_DARK },
  StatuslineFilenameSeparator = { fg = Color.BACKGROUND_DARK, bg = Color.BACKGROUND },
