...
local hlGroups = {
  ...
  Visual = { fg = Color.SEARCH, bg = Color.BACKGROUND_DARK },
  ...
  StatuslineFilename = { fg = Color.VARIABLE, bg = Color.BACKGROUND_DARKER },
  ...
  StatuslineFolder = { fg = Color.COMMENT_LIGHT, bg = Color.BACKGROUND_DARKER },
  StatuslineInactiveDiagnosticError = { fg = '#ae4b47', bg = Color.BACKGROUND},
  StatuslineInactiveDiagnosticHint = { fg = '#576c65', bg = Color.BACKGROUND},
  StatuslineInactiveDiagnosticInfo = { fg = '#6c7e91', bg = Color.BACKGROUND},
